    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diploma_url', models.CharField(max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cart', models.ManyToManyField(blank=True, related_name='cart_students', to='courses.course')),
                ('certificates', models.ManyToManyField(blank=True, related_name='student_certificates', to='certificates.certificate')),
                ...
                ('wishlist', models.ManyToManyField(blank=True, related_name='wishlist_students', to='courses.course')),
            ],
        ),
    ]
